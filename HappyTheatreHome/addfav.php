...
<body>
    ...
    <div class="container">
	   ...
	   $prodID = $_GET['prodid'];
	    if(!empty($prodID)){
        $sql = "INSERT INTO favorite (id, userid, fid) VALUES (NULL, 'userid', '".$prodID."');";
        $result = mysqli_query($connection,$sql);
		echo "<div class='alert alert-success'>Movie added to Favorites. You will be automatically redirected after 3 seconds.</div>";
